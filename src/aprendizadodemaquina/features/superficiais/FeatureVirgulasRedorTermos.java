...
/**
 * Feature que diz se há vírgulas ao redor dos termos de interesse.
 */
public class FeatureVirgulasRedorTermos extends Feature {

    @Override
    public String nome() {
        return "existe_virgula_ao_redor_termo";
    }
