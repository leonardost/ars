...
/**
 * Feature que traz o número de vírgulas que ocorrem entre os termos de
 * interesse.
 */
public class FeatureVirgulasEntreTermos extends Feature {

    @Override
    public String nome() {
        return "numero_virgulas_entre_termos";
    }
    ...
    public List<Object> gerar(Sentenca s, Termo t1, Termo t2) {
        ...
        for ( Token t : tokensEntre )
            if ( t.getToken().equals(",") )
                ++numeroVirgulas;
        valores.add( new Integer(numeroVirgulas) );
        return valores;
    }
